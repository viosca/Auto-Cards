...
function AutoCards(inHook, inText, inStop) {
    ...
    */
    ...
    const DEFAULT_DETECT_TITLES_FROM_INPUTS = true
    // (true or false)
    ...
    */
    ...
    function hoistWords() { return (class Words { static #cache = {}; static {
        ...
        const wordListInitializers = {
            ...
            entities: () => [
                ...
                "his", "him", "he'd", "her", "she", "she'd", "you", "your", "yours", "you'd", "you've", "you'll", "yourself", "mine", "myself",
            ...
            // Safe encodings of other undesirable titles which are implicitly banned from the card generation process
            undesirables: () => [
                [102, 117, 99, 107], [115, 104, 105, 116], [99, 114, 97, 112], [103, 45, 115, 112, 111, 116], [98, 100, 115, 109], [116, 104, 99], [117, 116, 105], [100, 97, 109, 110]
            ],
            delimiter: () => (
                "———————————————————————————"
            ),
    ...
    function see(arr) {
        // Internal.debugLog(JSON.stringify("example".split("").map(c => c.charCodeAt(0))));
